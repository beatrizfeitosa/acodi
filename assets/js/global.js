...
const form = {
	...
	pCoordinator: () => document.getElementById('p-coordinator'),
	aCoordinator: () => document.getElementById('a-coordinator'),
	educationalAdviser: () => document.getElementById('educational-advisor'),
	...
	pCoordinatorView: () => document.getElementById('p-coordinator-view'),
	aCoordinatorView: () => document.getElementById('a-coordinator-view'),
	educationalAdviserView: () => document.getElementById('educational-advisor-view'),
